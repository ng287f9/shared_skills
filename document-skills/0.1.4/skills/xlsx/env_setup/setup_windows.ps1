...
# ── Step 2c: LibreOffice (optional) ──
Write-Host "--- [3/5] LibreOffice (optional, format conversion) ---"
...
if (Test-Path $SofficePath) {
    ...
    Write-Warn "libreoffice not installed (needed only for .xlsx -> PDF or .csv -> .xlsx conversion)"
